        ...
        if (this.state.formValid) {
            ...
            .then((responseJson) => {
                ...
                if ( (typeof responseJson.success != 'undefined') && (responseJson.success == 'yes') ) {
                    window.location = this.props.appurl + '/home?emailCreated=yes'; 
                }
                else {
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-8">
                        <div className="card">
                            <div className="card-header"><h1>Create Email</h1></div>
                            ...
                            <form onSubmit={this._handleSubmit}>
                                ...
                                <button type="submit" className="btn btn-primary btn-lg btn-block" disabled={this.state.disabledButton}>Save this email</button>
...
if (document.getElementById('CreateEmail')) {
    const element = document.getElementById('CreateEmail')
    const props = Object.assign({}, element.dataset)
    ReactDOM.render(<CreateEmail {...props}/>, document.getElementById('CreateEmail'));
}
